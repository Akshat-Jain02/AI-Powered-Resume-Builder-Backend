...
class RequestLoggingFilterTest {
    ...
    void withTraceHeaders_propagates() throws Exception {
        MockHttpServletRequest req = new MockHttpServletRequest("GET", "/api/templates");
    ...
    void withoutHeaders_generates() throws Exception {
        MockHttpServletRequest req = new MockHttpServletRequest("POST", "/api/templates/pdf/generate");
        MockHttpServletResponse resp = new MockHttpServletResponse();
        FilterChain chain = mock(FilterChain.class);
        filter.doFilterInternal(req, resp, chain);
