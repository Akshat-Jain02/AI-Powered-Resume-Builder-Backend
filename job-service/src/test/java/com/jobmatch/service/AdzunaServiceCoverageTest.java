...
class AdzunaServiceCoverageTest {
    ...
    @Test
    void searchJobs_apiReturnsErrorNode_returnsEmptyList() {
    ...
    @Test
    void searchJobs_apiReturnsExceptionNode_returnsEmptyList() {
    ...
    @Test
    void searchJobs_apiReturnsNullResults_returnsEmptyList() {
    ...
    @Test
    void searchJobs_apiReturnsNonArrayResults_returnsEmptyList() {
    ...
    @Test
    void searchJobs_apiEmptyResponse_returnsEmptyList() {
    ...
    @Test
    void searchJobs_fullValidResponse_coversAllPropertyBranches() {
        String json = """
            {
              "count": 1,
              "results": [
        ...
        assertThat(j2.getLocation()).isEmpty();
    }
