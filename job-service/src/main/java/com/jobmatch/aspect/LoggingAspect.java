...
public class LoggingAspect {
    ...
    @Pointcut("within(com.jobmatch.controller..*) || within(com.jobmatch.service..*)")
    ...
    private String summarizeResult(Object r) { if (r == null) return "null"; if (r instanceof ResponseEntity<?> re) return "ResponseEntity[status=" + re.getStatusCode() + "]"; if (r instanceof byte[]) return "byte[" + ((byte[]) r).length + "]"; String s = String.valueOf(r); return s.length() > 200 ? s.substring(0, 200) + "...[truncated]" : s; }
}
