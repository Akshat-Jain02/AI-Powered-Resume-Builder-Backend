package com.resumeai.payment.aspect;
...
public class LoggingAspect {
    ...
    private static final String[] SENSITIVE_PARAMS = {"password", "token", "secret", "credential", "authorization", "razorpay"};
    ...
    @Pointcut("within(com.resumeai.payment.controller..*) || " +
            "within(com.resumeai.payment.service..*)")
