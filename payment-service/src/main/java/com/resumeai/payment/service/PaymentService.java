...
public class PaymentService {
    ...
    public OrderResponse createOrder(String username, String userEmail, CreateOrderRequest request)
        ...
        log.info("Creating order for user: {} with plan: {}", username, request.getPlanType());
        ...
        log.info("Order created: {} -> {}", payment.getOrderId(), razorpayOrderId);
    ...
    public PaymentResponse verifyAndProcessPayment(String username, String userEmail,
        ...
        log.info("Verifying payment for user: {} order: {}", username, request.getOrderId());
