...
import com.resumeai.payment.filter.HeaderAuthenticationFilter;

/**
 * Security configuration for payment-service (internal microservice).
 *
 * Runs behind the API Gateway. Trusts X-Username and X-Roles headers.
 * Admin endpoints are protected via @PreAuthorize in controllers.
 *
