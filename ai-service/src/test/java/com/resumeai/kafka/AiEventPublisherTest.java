...
class AiEventPublisherTest {
    ...
    void publishResumeAnalysis_validEmail_sendsEvent() {
        ...
        publisher.publishResumeAnalysis(new AiEventPublisher.ResumeAnalysisContext("bob", "bob@test.com", "resume.pdf"),
    ...
    void publishResumeAnalysis_nullEmail_skips() {
        publisher.publishResumeAnalysis(new AiEventPublisher.ResumeAnalysisContext("bob", null, "file.pdf"),
    ...
    void publishResumeAnalysis_blankEmail_skips() {
        publisher.publishResumeAnalysis(new AiEventPublisher.ResumeAnalysisContext("bob", "", "file.pdf"),
                "summary", List.of(), List.of(), List.of(), "7", "Dev");
        verify(kafkaTemplate, never()).send(anyString(), anyString(), any());
    }
    ...
    void publishResumeAnalysis_kafkaThrows_doesNotPropagate() {
        ...
        assertDoesNotThrow(() ->
            publisher.publishResumeAnalysis(new AiEventPublisher.ResumeAnalysisContext("bob", "b@c.com", "f.pdf"),
